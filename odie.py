...
def main(args, loglevel):
    ...
    print ("Welcome to odie. A python tool for image editing.")
    logging.info("Usage is ./odie.py --input inputfile.png -x 320 -y 480")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description = "./odie.py --input inputfile.png -x 320 -y 480",
